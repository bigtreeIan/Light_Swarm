...
#             if (swarmElement[1] == "1"):
#                 webresponse += "/static/OnMaster.png'style='position: absolute; top: "
#             else:
#                 webresponse += "/static/OnSlave.png'style='position: absolute; top: "
#         else:
#             if (swarmElement[4] == "TO"):
#                 webresponse += "/static/OffTimeOut.png'style='position: absolute; top: "
#             else:
#                 webresponse += "/static/OffNotPresent.png'style='position: absolute; top: "
#                 webresponse += str(100)
#                 webresponse += "px; left: " + str(20 + 120 * i) + "px;'/>\n"
#                 webresponse += "<figcaption"
#                 webresponse += " style='position: absolute; top: "
